...
def create_terrain_4():
    ...
    p.changeDynamics(terrain, -1, lateralFriction=1.5)
...
if __name__ == '__main__':
    ...
    model_path = f"{model_dir}/PPO_terrainSIX_IV_313.zip"  # Adjust the path topre-trained model
    ...
    try:
        while True:
            ...
            model_save_path = f"{model_dir}/PPO_terrainFOUR_lFIN_{count}.zip"
