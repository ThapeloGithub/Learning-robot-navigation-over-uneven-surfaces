...
def create_terrain_1():
    ...
    terrain_shape = p.createCollisionShape(
        ...
        heightfieldData=np.random.uniform(-2, 2, 256*256),
...
# Define the number of steps between captures (45 seconds in simulation time)
capture_interval_steps = 10800  # 45 seconds * 240 steps per second
